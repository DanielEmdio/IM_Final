...
public enum Output implements IOutput{
    ...
    */
    ...
    //--------------Complementary------------------------
    // COLAR_SELECIONAR_CELULA("[FUSION][SELECIONAR_CELULAS][CELULA][COLAR]"),
    // APAGAR_SELECIONAR_CELULA("[FUSION][SELECIONAR_CELULAS][CELULA][APAGAR]"),
    BOLD_ESCREVER_CONTEUDO("[FUSION][BOLD_ESCREVER_CONTEUDO]"),

    //--------------Single----------------------------------
    // ESCREVER_CONTEUDO_DEFAULT("[FUSION][ESCREVER_CONTEUDO][VALOR]"),
    ALTERAR_TAMANHO_TEXTO("[FUSION][ALTERAR_TAMANHO_TEXTO][TAMANHO]"),
    // SELECIONAR_CELULAS("[FUSION][SELECIONAR_CELULAS][CELULA]"),
    //gestures
