...
public enum Speech implements IModality{  
	...
	*/
	...
	// ------------------------Complementary------------------------
	SELECIONAR_AREA("[SPEECH][SELECIONAR_AREA]",4000),
	SELECIONAR_CELULAS("[SPEECH][SELECIONAR_CELULAS]",4000),
	ESCREVER_CONTEUDO("[SPEECH][ESCREVER_CONTEUDO]",4000),

	FECHAR("[SPEECH][FECHAR]",4000),
	APAGAR("[SPEECH][APAGAR]",4000),
